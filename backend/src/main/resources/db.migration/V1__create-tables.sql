...
(
    ...
    status                          varchar (255) check (status in ('ATIVO', 'INATIVO')) not null default 'ATIVO',
...
(
    ...
    beneficiary_status              varchar(255) check (beneficiary_status in ('PENDENTE', 'APROVADO', 'REPROVADO')) not null default 'PENDENTE',
...
create table donation (
    ...
    donation_date               timestamp(6) not null,
